...
host1 = 'root@192.168.11.26'
host2 = 'heat-admin@192.168.11.57'
host3 = 'heat-admin@192.168.11.59'
host4 = 'heat-admin@192.168.11.62'
host5 = 'heat-admin@192.168.11.63'
host6 = 'heat-admin@192.168.11.64'


#External routers if any
#for eg.
#ext_routers = [('mx1', '192.168.11.1')]
ext_routers = []
...
env.roledefs = {
    ...
    #'rally': [host11], # Optional, to enable/setup rally, it can be a seprate node from contrail cluster
     'vgw': [host3, host5], # Optional, Only to enable VGW. Only compute can support vgw
...
env.hostnames = {
    host1: 'centos',
    host2: 'overcloud-controller-0',
    host3: 'overcloud-compute-1',
    host4: 'overcloud-controller-1',
    host5: 'overcloud-compute-0',
    host6: 'overcloud-controller-2',
}

#Openstack admin password
env.openstack_admin_password = '8jNKeRh3jUPa9rFr3TcBdyZxR'
...
env.keystone = {
    'keystone_ip'     : '192.168.11.52',
    'auth_protocol'   : 'http',                  #Default is http
    'auth_port'       : '35357',                 #Default is 35357
    'admin_token'     : 'jm4QZuuap9heNFpcRyfnTtqAK',  #admin_token in keystone.conf
    'admin_user'      : 'admin',                 #Default is admin
    'admin_password'  : '8jNKeRh3jUPa9rFr3TcBdyZxR',           #Default is contrail123
    'nova_password'   : 'XpVuRcpx24bZhTqm8fc9faA2D',           #Default is the password set in admin_password
    'neutron_password': '6PYQjBwXrNuERmnvmHssW6k8c',           #Default is the password set in admin_password
...
env.ha = {
	'internal_vip' : '192.168.11.52',
	'contrail_internal_vip' : '192.168.11.36',
}
...
env.openstack = {
    'service_token' : 'jm4QZuuap9heNFpcRyfnTtqAK', 	#Common service token for for all openstack services
    'amqp_host' : '192.168.11.57',            #IP of AMQP Server to be used in openstack
    'manage_amqp' : 'no',                    #Default no, Manage seperate AMQP for openstack services in openstack nodes.
    'osapi_compute_workers' : 5,             #Default 40, For low memory system reduce the osapi compute workers thread.
    'conductor_workers' : 5,                 #Default 40, For low memory system reduce the conductor workers thread.
}

env.cfgm = {
    'amqp_hosts' : ['192.168.11.26, 192.168.11.59, 192.168.11.63, 192.168.11.57, 192.168.11.62, 192.168.11.64'],
    'amqp_port' : '5672'           
}
